...
Deno.test("BigInteger 1~9 EndExclusive", { permissions: "none" }, () => {
	deepStrictEqual(Array.from(rangeIterator(1n, 9n, { endExclusive: true })), [1n, 2n, 3n, 4n, 5n, 6n, 7n, 8n]);
});
...
Deno.test("BigInteger 9~1 EndExclusive", { permissions: "none" }, () => {
	deepStrictEqual(Array.from(rangeIterator(9n, 1n, { endExclusive: true })), [9n, 8n, 7n, 6n, 5n, 4n, 3n, 2n]);
});
