...
Deno.test("BigInteger 1~9", { permissions: "none" }, () => {
	deepStrictEqual(Array.from(rangeIterator(1n, 9n)), [1n, 2n, 3n, 4n, 5n, 6n, 7n, 8n, 9n]);
});
Deno.test("BigInteger 1~9 Excludes 4", { permissions: "none" }, () => {
	deepStrictEqual(Array.from(rangeIterator(1n, 9n, { excludes: [4n] })), [1n, 2n, 3n, 5n, 6n, 7n, 8n, 9n]);
});
